...
import { Settings, ShieldCheck, Building2, Sliders, Smartphone, ArrowLeft } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Gestión de parámetros del tenant, conexión WhatsApp Business y usuarios autorizados.
          </p>
        </div>
        ...
        <CardContent className="flex flex-col items-center justify-center py-16 text-center space-y-4">
          ...
          <div className="max-w-md space-y-1">
            ...
            <p className="text-sm text-slate-500">
              Personaliza el tono de respuesta del asistente, números de derivación de guardia, credenciales de WhatsApp Cloud API y políticas de retención de datos.
            </p>
          </div>

          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-100 text-xs text-slate-600 font-mono">
            <span>Ruta: <code>/settings</code></span>
            <span>•</span>
